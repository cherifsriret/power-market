...
const actions = {
    ...
    postMessage({commit, state}) {
        ...
        axios.post('/admin/social/posts', { body: state.postMessage })
            .then(res => {
    ...
    likePost({commit, state}, data) {
        axios.post('/admin/social/posts/' + data.postId + '/like')
            .then(res => {
    ...
    commentPost({commit, state}, data) {
        axios.post('/admin/social/posts/' + data.postId + '/comment', { body: data.body })
            .then(res => {
