...
<div class="card m-2">
    ...
    <div class="card-body">
      <form method="post" action="{{route('maintenance_statements.update',$maintenance_statement->id)}}">
        @csrf
        @method('PATCH')
            <div class="row">
              <div class="col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description">{{$maintenance_statement->description}}</textarea>
                    @error('description')
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 date">
                        <input type="text" class="form-control" value="{{$maintenance_statement->maintenance_date}}" name="maintenance_date" id="maintenance_date" placeholder="{{__('maintenance_statement.enter_maintenance_date')}}">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 date">
                        <input type="number" class="form-control" value="{{$maintenance_statement->price}}" name="price" id="price" placeholder="{{__('maintenance_statement.enter_price')}}">
                        <div class="input-group-append">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" value="{{$maintenance_statement->technician_name}}" name="technician_name" id="technician_name" placeholder="{{__('maintenance_statement.enter_technician_name')}}">
                        <div class="input-group-append">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" value="{{$maintenance_statement->technician_phone}}" name="technician_phone" id="technician_phone" placeholder="{{__('maintenance_statement.enter_technician_phone')}}">
                        <div class="input-group-append">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input id="thumbnail" class="form-control" value="{{$maintenance_statement->photo}}" type="text" readonly name="photo" >
                      </div>
                ...
                <div class="form-group">
                    ...
                    <select name="building_id" class="form-control">
                        ...
                        @foreach ($buildings as $building)
                            <option value="{{$building->id}}" {{(($building->id==$maintenance_statement->building_id) ? 'selected' : '')}}>{{$building->name}}</option>
                        @endforeach
                    </select>
                  @error('building_id')
                  <span class="text-danger">{{$message}}</span>
