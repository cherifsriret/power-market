...
<div class="card m-2">
    ...
    <div class="card-body">
      <form method="post" action="{{route('cleaning_companies.store')}}">
        {{csrf_field()}}
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" name="name" id="name" placeholder="{{__('cleaning_company.enter_name')}}">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" name="address" id="address" placeholder="{{__('cleaning_company.enter_address')}}">
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-calendar-alt"></i></div>
                          </div>
                      </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" name="phone" id="phone" placeholder="{{__('cleaning_company.enter_phone')}}">
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-calendar-alt"></i></div>
                          </div>
                      </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" name="responsable" id="responsable" placeholder="{{__('cleaning_company.enter_responsable')}}">
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-calendar-alt"></i></div>
                          </div>
                      </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" name="maps" id="maps" placeholder="{{__('cleaning_company.enter_maps')}}">
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-calendar-alt"></i></div>
                          </div>
                      </div>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="form-group">
                    <label for="inputTitle" class="col-form-label">{{__('cleaning_company.cv')}}</label>
...
<script>
    ...
    $('#cv').summernote({
        placeholder: "{{__('cleaning_company.enter_cv')}}",
          tabsize: 2,
          height: 150
      });
