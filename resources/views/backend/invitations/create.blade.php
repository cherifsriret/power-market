        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                  ...
                  <input id="inputTitle" type="text" name="visitor_name" placeholder="{{__('invitation.enter_visitor_name')}}"  value="{{old('visitor_name')}}" class="form-control">
                  @error('visitor_name')
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 date">
                        <input type="text" class="form-control" name="visit_from_date" id="visit_from_date" placeholder="{{__('invitation.enter_visit_from_date')}}">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2  bootstrap-timepicker timepicker">
                        <input type="text" class="form-control"  value="{{old('visit_from_time')}}" name="visit_from_time" id="visit_from_time" placeholder="{{__('invitation.enter_visit_from_time')}}">
                        <div class="input-group-append">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 date">
                        <input type="text" class="form-control" name="visit_to_date" id="visit_to_date" placeholder="{{__('invitation.enter_visit_to_date')}}">
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-calendar-alt"></i></div>
                          </div>
                      </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2  bootstrap-timepicker timepicker">
                        <input type="text" class="form-control"  value="{{old('visit_to_time')}}" name="visit_to_time" id="visit_to_time" placeholder="{{__('invitation.enter_visit_to_time')}}">
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-clock"></i></div>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <select name="visit_type" class="form-control">
                        ...
                        <option value="single">{{__('invitation.single_visit')}}</option>
                        <option value="multiple">{{__('invitation.multiple_visit')}}</option>
                    </select>
                  @error('visit_type')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
