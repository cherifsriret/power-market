...
<div class="card m-2">
    ...
    <h5 class="card-header">{{__('place.update_place')}}</h5>
    <div class="card-body">
            ...
            <div class="col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" name="address" value="{{$place->address}}" id="address" placeholder="{{__('place.enter_address')}}">
                      </div>
                  @error('address')
              ...
              <div class="col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input id="thumbnail" class="form-control" type="text" name="photo"  value="{{$place->photo}}" >
                      </div>
